...
SYNTH_SPECS: list[SynthSpec] = [
    ...
    SynthSpec("Health Facility Density (per 10k)", 0.05, 8.0, 0.05, 0.3),
    # Governance / data
    SynthSpec("Civil Registration Completeness", 0, 100, 0.8, 8.0),
    SynthSpec("HIS Maturity Index", 0, 1, 0.015, 0.08),
    SynthSpec("Maternal Death Reviews Coverage", 0, 100, 1.0, 10.0),
    SynthSpec("Reporting Completeness", 0, 100, 1.0, 10.0),
    SynthSpec("Reporting Timeliness", 0, 100, 1.0, 10.0),
