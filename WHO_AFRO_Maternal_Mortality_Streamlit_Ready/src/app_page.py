...
def render_app() -> None:
    ...
    with tab_whatif:
        ...
        with col_side:
            ...
            baseline_mean, baseline_lo, baseline_hi = predict_mmr_interval(model, model_baseline)
        ...
        with col_main:
            predicted_mean, predicted_lo, predicted_hi = predict_mmr_interval(model, model_scenario)
            ...
            if do_project:
                ...
                for _, r in proj.iterrows():
                    ...
                    m, lo, hi = predict_mmr_interval(model, feats)
                    means.append(m)
                    lo95.append(lo)
                    hi95.append(hi)
                proj["mmr_mean"] = means
                ...
                st.caption("Band shows 95% predictive interval from the Bayesian model.")
    ...
    with tab_about:
        st.markdown(
            ...
            ### Model
            Bayesian linear regression (BayesianRidge) on log(MMR) using country-year panel (2000–2023).
