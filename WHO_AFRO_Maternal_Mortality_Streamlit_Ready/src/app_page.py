...
def render_app() -> None:
    ...
    with tab_whatif:
        ...
        with col_side:
            ...
            st.markdown(
                "Adjust levers below (defaults = latest values). "
                "**Green hints** = moving the slider **up** should **lower** MMR "
                "(e.g. ANC4, government health spending, skilled birth attendance). "
                "**Orange hints** = moving **up** increases projected MMR (risk factors)."
            )
