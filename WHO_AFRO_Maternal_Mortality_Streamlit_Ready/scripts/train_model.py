...
def main() -> None:
    ...
    # Constrained monotonic model in risk-oriented space:
    ...
    # Bootstrap uncertainty (lightweight, robust)
    ...
    for b in range(B):
        ...
        m.fit(Xs[idx], y.to_numpy(dtype=float)[idx])
        coefs[b] = m.coef_
    ...
    metrics = {
        ...
        "uncertainty_method": {"type": "bootstrap_linear_positive", "n_models": int(B)},
    }
